...
var CONFIG = 'kuopio';
var APP_TITLE = 'kuopio.digitransit.fi';
var APP_DESCRIPTION = 'Kuopion uusi reittiopas';
...
export default configMerger(walttiConfig, {
  ...
  defaultOrigins: [{ icon: 'icon-icon_bus', label: 'Linja-autoasema, Kuopio', lat: 62.898516, lon: 27.679409 }, { icon: 'icon-icon_rail', label: 'Rautatieasema, Kuopio', lat: 62.896875, lon: 27.680523 }, { icon: 'icon-icon_school', label: 'Itä-Suomen yliopisto, Kuopio', lat: 62.894982, lon: 27.640932 }],

  footer: {
    content: [{ label: function () {
        return '\xA9 Kuopio ' + (1900 + new Date().getYear());
      }() }, {}, { name: 'footer-feedback', nameEn: 'Submit feedback', href: 'https://palaute.kuopio.fi/fi#!/palautelomake/27050/27054', icon: 'icon-icon_speech-bubble' }, { name: 'about-this-service', nameEn: 'About this service', route: '/tietoja-palvelusta', icon: 'icon-icon_info' }]
  },
