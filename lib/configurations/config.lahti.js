...
var CONFIG = 'lahti';
var APP_TITLE = 'Uusi Reittiopas';
var APP_DESCRIPTION = 'Uusi Reittiopas - Lahti';

var walttiConfig = require('./waltti').default;

var minLat = 60.692506;
var maxLat = 61.790694;
var minLon = 24.873833;
var maxLon = 26.544819;
...
export default configMerger(walttiConfig, {
  ...
  defaultOrigins: [{ icon: 'icon-icon_bus', label: 'Matkakeskus, Lahti', lat: 60.977050, lon: 25.658567 }, { icon: 'icon-icon_bus', label: 'Kauppatori, Lahti', lat: 60.983595, lon: 25.656391 }, { icon: 'icon-icon_bus', label: 'Päijät-Hämeen keskussairaala, Lahti', lat: 60.991045, lon: 25.567989 }],

  footer: {
    content: [{ label: function () {
        return '\xA9 Lahti ' + (1900 + new Date().getYear());
      }() }, {}, { name: 'footer-feedback', nameEn: 'Submit feedback', href: 'https://e-asiointi.lahti.fi/eFeedback/fi/Feedback/29-Joukkoliikenne', icon: 'icon-icon_speech-bubble' }, { name: 'about-this-service', nameEn: 'About this service', route: '/tietoja-palvelusta', icon: 'icon-icon_info' }]
  },
