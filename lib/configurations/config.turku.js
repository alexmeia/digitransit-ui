...
var CONFIG = 'turku';
var APP_TITLE = 'Fölin reittiopas';
var APP_DESCRIPTION = 'Fölin reittiopas uudistuu. Tule mukaan! Ota uuden uuden sukupolven matkaopas käyttöösi.';
...
export default configMerger(walttiConfig, {
  ...
  footer: {
    content: [{ label: function () {
        return '\xA9 Turun seudun joukkoliikenne ' + (1900 + new Date().getYear());
  ...
  defaultOrigins: [{ icon: 'icon-icon_bus', label: 'Kauppatori, Turku', lat: 60.451159, lon: 22.267633 }, { icon: 'icon-icon_rail', label: 'Rautatieasema, Turku', lat: 60.453537, lon: 22.253379 }, { icon: 'icon-icon_airplane', label: 'Lentoasema, Turku', lat: 60.511092, lon: 22.274211 }],
