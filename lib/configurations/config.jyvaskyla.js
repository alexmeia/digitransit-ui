...
var CONFIG = 'jyvaskyla';
var APP_TITLE = 'Reittiopas Jyväskylä';
var APP_DESCRIPTION = 'Jyväskylän uusi reittiopas';

var walttiConfig = require('./waltti').default;

var minLat = 61.835318;
var maxLat = 62.603473;
var minLon = 25.230388;
var maxLon = 26.358237;

export default configMerger(walttiConfig, {
  CONFIG: CONFIG,

  feedIds: ['KeskiSuomenEly'],
  ...
  defaultOrigins: [{ icon: 'icon-icon_bus', label: 'Paikallisliikenneterminaali, Jyväskylä', lat: 62.2410157, lon: 25.7485346 }, { icon: 'icon-icon_bus', label: 'Kauppatori, Jyväskylä', lat: 62.244958, lon: 25.746471 }, { icon: 'icon-icon_bus', label: 'Keski-Suomen keskussairaala, Jyväskylä', lat: 62.229935, lon: 25.710604 }],
  ...
  footer: {
    content: [{ label: function () {
        return '\xA9 Jyvaskyla ' + (1900 + new Date().getYear());
      }() }, {}, { name: 'footer-feedback', nameEn: 'Submit feedback', href: 'https://s-asiointi.jkl.fi/eFeedback/fi/Feedback/24/113', icon: 'icon-icon_speech-bubble' }, { name: 'about-this-service', nameEn: 'About this service', route: '/tietoja-palvelusta', icon: 'icon-icon_info' }]
  },
