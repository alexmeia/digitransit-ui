...
var CONFIG = 'oulu';
var APP_DESCRIPTION = 'Oulun seudun uusi reittiopas';
var APP_TITLE = 'Reittiopas';
...
export default configMerger(walttiConfig, {
  ...
  defaultOrigins: [{ icon: 'icon-icon_bus', label: 'Kauppatori, Oulu', lat: 65.013559, lon: 25.465032 }, { icon: 'icon-icon_rail', label: 'Rautatieasema, Oulu', lat: 65.011523, lon: 25.483571 }, { icon: 'icon-icon_airplane', label: 'Lentoasema, Oulu', lat: 64.928808, lon: 25.373296 }],

  footer: {
    content: [{ label: function () {
        return '\xA9 Oulu ' + (1900 + new Date().getYear());
      }() }, {}, { name: 'footer-feedback', nameEn: 'Submit feedback', href: 'http://www.oulunjoukkoliikenne.fi/palautteet', icon: 'icon-icon_speech-bubble' }, { name: 'about-this-service', nameEn: 'About this service', route: '/tietoja-palvelusta', icon: 'icon-icon_info' }]
  },
