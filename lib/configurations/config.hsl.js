var CONFIG = 'hsl';
var API_URL = process.env.API_URL || 'https://dev-api.digitransit.fi';
var MAP_URL = process.env.MAP_URL || 'https://digitransit-dev-cdn-origin.azureedge.net';
var APP_DESCRIPTION = 'Helsingin seudun liikenteen uusi Reittiopas.';
...
export default {
  ...
  footer: {
    content: [{ label: function () {
        return '\xA9 HSL ' + (1900 + new Date().getYear());
      }() }, {}, { name: 'footer-faq', nameEn: 'FAQ', href: 'https://www.hsl.fi/ohjeita-ja-tietoja/reittiopas' }, { name: 'footer-feedback', nameEn: 'Submit feedback', href: 'https://www.hsl.fi/palaute', icon: 'icon-icon_speech-bubble' }, { name: 'about-this-service', nameEn: 'About the service', route: '/tietoja-palvelusta', icon: 'icon-icon_info' }, { name: 'footer-link-to-privacy-policy', nameEn: 'Privacy policy', href: 'https://www.hsl.fi/tietoa-sivustosta' }, { name: 'footer-link-to-old', nameEn: 'Go to the old Journey Planner', href: 'http://classic.reittiopas.fi/' }]
  },
  ...
  defaultOrigins: [{ icon: 'icon-icon_rail', label: 'Rautatieasema, Helsinki', lat: 60.1710688, lon: 24.9414841 }, { icon: 'icon-icon_airplane', label: 'Lentoasema, Vantaa', lat: 60.317429, lon: 24.9690395 }, { icon: 'icon-icon_bus', label: 'Kampin bussiterminaali, Helsinki', lat: 60.16902, lon: 24.931702 }],
  ...
  staticMessages: [{ id: '2',
    content: {
      fi: [{ type: 'text', content: 'Käytämme evästeitä palveluidemme kehitykseen. Käyttämällä sivustoa hyväksyt evästeiden käytön. Lue lisää: ' }, { type: 'a', content: 'Käyttöehdot', href: 'https://www.hsl.fi/kayttoehdot' }, { type: 'a', content: 'Tietosuojaseloste', href: 'https://www.hsl.fi/tietosuojaseloste' }],
      en: [{ type: 'text', content: 'We use cookies to improve our services. By using this site, you agree to its use of cookies. Read more: ' }, { type: 'a', content: 'Terms of use', href: 'https://www.hsl.fi/en/terms-of-use' }, { type: 'a', content: 'Privacy Statement', href: 'https://www.hsl.fi/en/description-of-the-file' }],
      sv: [{ type: 'text', content: 'Vi använder cookies för att utveckla våra tjänster. Genom att använda webbplatsen godkänner du att vi använder cookies. Läs mer: ' }, { type: 'a', content: 'Användarvillkor', href: 'https://www.hsl.fi/sv/anvandarvillkor' }, { type: 'a', content: 'Dataskyddsbeskrivning', href: 'https://www.hsl.fi/sv/dataskyddsbeskrivning' }]
    }
  }] };