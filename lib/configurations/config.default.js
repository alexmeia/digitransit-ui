var CONFIG = process.env.CONFIG || 'default';
...
var APP_PATH = process.env.APP_CONTEXT || '';
var PIWIK_ADDRESS = process.env.PIWIK_ADDRESS;
var PIWIK_ID = process.env.PIWIK_ID;
var SENTRY_DSN = process.env.SENTRY_DSN;
var PORT = process.env.PORT || 8080;
var APP_DESCRIPTION = 'Digitransit journey planning UI';
var OTP_TIMEOUT = process.env.OTP_TIMEOUT || 10000; // 10k is the current server default
...
export default {
  ...
  footer: {
    content: [{ label: function () {
        return '\xA9 HSL, Liikennevirasto ' + (1900 + new Date().getYear());
      }() }, {}, { name: 'footer-feedback', nameEn: 'Submit feedback', href: 'https://github.com/HSLdevcom/digitransit-ui/issues', icon: 'icon-icon_speech-bubble' }, { name: 'about-this-service', nameEn: 'About this service', route: '/tietoja-palvelusta', icon: 'icon-icon_info' }]
  },
  ...
  defaultOrigins: [{ icon: 'icon-icon_airplane', label: 'Helsinki-Vantaan lentoasema', lat: 60.317429, lon: 24.9690395 }, { icon: 'icon-icon_ferry', label: 'Turun satama', lat: 60.436363, lon: 22.220002 }, { icon: 'icon-icon_airplane', label: 'Rovaniemen lentoasema', lat: 66.557326, lon: 25.828135 }],
  ...
  { id: '10', expr: 'dev-joensuu' }, { id: '11', expr: 'joensuu' }, { id: '12', expr: 'dev-turku' }, { id: '13', expr: 'turku' },
  ...
  { id: '5', expr: 'dev.reittiopas' }, { id: '4', expr: 'reittiopas' }, { id: '7', expr: 'dev.matka' }, { id: '6', expr: 'matka' }, { id: '7', expr: 'dev.digitransit' }, { id: '6', expr: 'digitransit' }],
