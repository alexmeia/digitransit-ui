...
var CONFIG = 'lappeenranta';
var APP_TITLE = 'reittiopas.lappeenranta.fi';
var APP_DESCRIPTION = '';
...
export default configMerger(walttiConfig, {
  ...
  defaultOrigins: [{ icon: 'icon-icon_city', label: 'Oleksi/Koulukatu', lat: 61.059097, lon: 28.185720 }, { icon: 'icon-icon_rail', label: 'Matkakeskus', lat: 61.0483, lon: 28.1945 }, { icon: 'icon-icon_school', label: 'Lappeenrannan teknillinen yliopisto', lat: 61.065, lon: 28.0949 }],

  footer: {
    content: [{ label: function () {
        return '\xA9 Lappeenranta ' + (1900 + new Date().getYear());
