...
var CONFIG = 'hameenlinna';
var APP_TITLE = 'reittiopas.hameenlinna.fi';
var APP_DESCRIPTION = '';
...
export default configMerger(walttiConfig, {
  ...
  defaultOrigins: [{ icon: 'icon-icon_bus', label: 'Hämeenlinnan linja-autoasema', lat: 60.9952717075545, lon: 24.4662911533486 }, { icon: 'icon-icon_rail', label: 'Hämeenlinnan rautatieasema', lat: 61.002179, lon: 24.478192 }],

  footer: {
    content: [{ label: function () {
        return '\xA9 Hameenlinna ' + (1900 + new Date().getYear());
      }() }, {}, { name: 'footer-feedback', nameEn: 'Submit feedback', href: 'http://kartta.hameenlinna.fi/eFeedback/fi/Feedback/35-Joukkoliikenne', icon: 'icon-icon_speech-bubble' }, { name: 'about-this-service', nameEn: 'About this service', route: '/tietoja-palvelusta', icon: 'icon-icon_info' }]
  },
