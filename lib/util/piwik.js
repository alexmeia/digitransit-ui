...
var Piwik = function () {
    ...
    function isDefined(property) {
        ...
        var propertyType = typeof property === 'undefined' ? 'undefined' : _typeof(property);
    ...
    function isObject(property) {
        return (typeof property === 'undefined' ? 'undefined' : _typeof(property)) === 'object';
    }
    ...
    var query = {
        ...
        getAttributeValueFromNode: function getAttributeValueFromNode(node, attributeName) {
            ...
            var typeOfAttr = _typeof(node.attributes[attributeName]);
    ...
    var content = {
        ...
        findContentNodes: function findContentNodes() {
        ...
        findContentNodesWithinNode: function findContentNodesWithinNode(node) {
            if (!node) {
                return [];
            }
        ...
        findParentContentNode: function findParentContentNode(anyNode) {
            if (!anyNode) {
                return;
            }
        ...
        findPieceNode: function findPieceNode(node) {
            var contentPiece;
        ...
        findTargetNodeNoDefault: function findTargetNodeNoDefault(node) {
            if (!node) {
                return;
            }
        ...
        findTargetNode: function findTargetNode(node) {
        ...
        findContentName: function findContentName(node) {
            if (!node) {
                return;
            }
        ...
        findContentPiece: function findContentPiece(node) {
            if (!node) {
                return;
            }
        ...
        findContentTarget: function findContentTarget(node) {
            if (!node) {
                return;
            }
        ...
        removeDomainIfIsInLink: function removeDomainIfIsInLink(text) {
        ...
        findMediaUrlInNode: function findMediaUrlInNode(node) {
            if (!node) {
                return;
            }
        ...
        isOrWasNodeInViewport: function isOrWasNodeInViewport(node) {
            ...
            return (rect.bottom > 0 || wasVisible) && rect.right > 0 && rect.left < docWidth && (rect.top < docHeight || wasVisible) // rect.top < 0 we assume user has seen all the ones that are above the current viewport
            ;
        },
        ...
        buildInteractionRequestParams: function buildInteractionRequestParams(interaction, name, piece, target) {
            var params = '';
        ...
        buildImpressionRequestParams: function buildImpressionRequestParams(name, piece, target) {
        ...
        buildContentBlock: function buildContentBlock(node) {
            if (!node) {
                return;
            }
        ...
        collectContent: function collectContent(contentNodes) {
        ...
        isUrlToCurrentDomain: function isUrlToCurrentDomain(url) {
        ...
        setHrefAttribute: function setHrefAttribute(node, url) {
            if (!node || !url) {
                return;
            }
        ...
        shouldIgnoreInteraction: function shouldIgnoreInteraction(targetNode) {
    ...
    function Tracker(trackerUrl, siteId) {
         ...
         */
        function _getRequest(request, customData, pluginMethod, currentEcommerceOrderTs) {
            var i,
                now = new Date(),
                nowTs = Math.round(now.getTime() / 1000),
                referralTs,
        ...
        heartBeatPingIfActivityAlias = function heartBeatPingIfActivity() {
            ...
            if (lastTrackerRequestTime + configHeartBeatDelay <= now.getTime()) {
                var requestPing = _getRequest('ping=1', null, 'ping');
        ...
        function logEcommerce(orderId, grandTotal, subTotal, tax, shipping, discount) {
            ...
            request = _getRequest(request, configCustomData, 'ecommerce', lastEcommerceOrderTs);
        ...
        function logPageView(customTitle, customData) {
            var now = new Date(),
                request = _getRequest('action_name=' + encodeWrapper(titleFixup(customTitle || configTitle)), customData, 'log');
        ...
        function buildContentInteractionRequest(interaction, name, piece, target) {
            ...
            return _getRequest(params, null, 'contentInteraction');
        }
        ...
        function buildContentImpressionsRequests(contents, contentNodes) {
            ...
            for (index = 0; index < contents.length; index++) {
                ...
                request = _getRequest(content.buildImpressionRequestParams(contents[index].name, contents[index].piece, contents[index].target), undefined, 'contentImpressions');
        ...
        function buildContentImpressionRequest(contentName, contentPiece, contentTarget) {
            ...
            return _getRequest(params, null, 'contentImpression');
        }
        ...
        function logEvent(category, action, name, value, customData) {
            ...
            var request = _getRequest(buildEventRequest(category, action, name, value), customData, 'event');
        ...
        function logSiteSearch(keyword, category, resultsCount, customData) {
            var request = _getRequest('search=' + encodeWrapper(keyword) + (category ? '&search_cat=' + encodeWrapper(category) : '') + (isDefined(resultsCount) ? '&search_count=' + resultsCount : ''), customData, 'sitesearch');
        ...
        function logGoal(idGoal, customRevenue, customData) {
            var request = _getRequest('idgoal=' + idGoal + (customRevenue ? '&revenue=' + customRevenue : ''), customData, 'goal');
        ...
        function logLink(url, linkType, customData, callback, sourceElement) {
            ...
            var request = _getRequest(linkParams, customData, 'link');
        ...
        function getKeyCodeFromEvent(event) {
            ...
            var typeOfEventButton = _typeof(event.button);
        ...
        return {
             ...
             */
            getAttributionInfo: function getAttributionInfo() {
             ...
             * @return string
             */
            getAttributionCampaignName: function getAttributionCampaignName() {
             ...
             * @return string
             */
            getAttributionCampaignKeyword: function getAttributionCampaignKeyword() {
             ...
             */
            getAttributionReferrerTimestamp: function getAttributionReferrerTimestamp() {
             ...
             */
            getAttributionReferrerUrl: function getAttributionReferrerUrl() {
             ...
             */
            setTrackerUrl: function setTrackerUrl(trackerUrl) {
                configTrackerUrl = trackerUrl;
            },
             ...
             * @returns string
             */
            getTrackerUrl: function getTrackerUrl() {
             ...
             */
            setCustomData: function setCustomData(key_or_obj, opt_value) {
             ...
             */
            setCustomRequestProcessing: function setCustomRequestProcessing(customRequestContentProcessingLogic) {
             ...
             */
            appendToTrackingUrl: function appendToTrackingUrl(queryString) {
             ...
             */
            setCustomVariable: function setCustomVariable(index, name, value, scope) {
                var toRecord;
             ...
             */
            getCustomVariable: function getCustomVariable(index, scope) {
                var cvar;
             ...
             * @param int index Custom variable slot ID from 1-5
             */
            deleteCustomVariable: function deleteCustomVariable(index, scope) {
             ...
             */
            storeCustomVariablesInCookie: function storeCustomVariablesInCookie() {
             ...
             * @param int delay
             */
            setLinkTrackingTimer: function setLinkTrackingTimer(delay) {
             ...
             */
            setDownloadExtensions: function setDownloadExtensions(extensions) {
             ...
             */
            addDownloadExtensions: function addDownloadExtensions(extensions) {
                var i;
                if (isString(extensions)) {
                    extensions = extensions.split('|');
                }
             ...
             * @param string|array extensions  for example 'custom' or ['custom1','custom2','custom3']
             */
            removeDownloadExtensions: function removeDownloadExtensions(extensions) {
                var i,
                    newExtensions = [];
                if (isString(extensions)) {
                    extensions = extensions.split('|');
             ...
             */
            setDomains: function setDomains(hostsAlias) {
             ...
             */
            setIgnoreClasses: function setIgnoreClasses(ignoreClasses) {
             ...
             */
            setRequestMethod: function setRequestMethod(method) {
             ...
             */
            setRequestContentType: function setRequestContentType(requestContentType) {
             ...
             */
            setDownloadClasses: function setDownloadClasses(downloadClasses) {
             ...
             */
            setLinkClasses: function setLinkClasses(linkClasses) {
             ...
             */
            setCampaignNameKey: function setCampaignNameKey(campaignNames) {
             ...
             */
            setCampaignKeywordKey: function setCampaignKeywordKey(campaignKeywords) {
             ...
             */
            setCookieNamePrefix: function setCookieNamePrefix(cookieNamePrefix) {
             ...
             * @param int timeout
             */
            setSessionCookieTimeout: function setSessionCookieTimeout(timeout) {
             ...
             * @param int timeout
             */
            setReferralCookieTimeout: function setReferralCookieTimeout(timeout) {
             ...
             */
            setConversionAttributionFirstReferrer: function setConversionAttributionFirstReferrer(enable) {
             ...
             */
            disableCookies: function disableCookies() {
             ...
             */
            setDoNotTrack: function setDoNotTrack(enable) {
             ...
             */
            addListener: function addListener(element, enable) {
             ...
             */
            enableJSErrorTracking: function enableJSErrorTracking() {
                if (_enableJSErrorTracking) {
                    return;
                }

                _enableJSErrorTracking = true;
             ...
             */
            disablePerformanceTracking: function disablePerformanceTracking() {
             ...
             */
            setGenerationTimeMs: function setGenerationTimeMs(generationTime) {
             ...
             */
            enableHeartBeatTimer: function enableHeartBeatTimer(heartBeatDelayInSeconds) {
             ...
             */
            redirectFile: function redirectFile(url) {
             ...
             */
            setCountPreRendered: function setCountPreRendered(enable) {
             ...
             */
            trackGoal: function trackGoal(idGoal, customRevenue, customData) {
                trackCallback(function () {
             ...
             */
            trackLink: function trackLink(sourceUrl, linkType, customData, callback) {
                trackCallback(function () {
             ...
             */
            trackAllContentImpressions: function trackAllContentImpressions() {
                if (isOverlaySession(configTrackerSiteId)) {
                    return;
                }
             ...
             */
            trackVisibleContentImpressions: function trackVisibleContentImpressions(checkOnSroll, timeIntervalInMs) {
                if (isOverlaySession(configTrackerSiteId)) {
                    return;
                }
             ...
             */
            trackContentImpression: function trackContentImpression(contentName, contentPiece, contentTarget) {
                if (isOverlaySession(configTrackerSiteId)) {
                    return;
                }
             ...
             */
            trackContentImpressionsWithinNode: function trackContentImpressionsWithinNode(domNode) {
             ...
             * @param string [contentTarget] For instance the URL of a landing page.
             */
            trackContentInteraction: function trackContentInteraction(contentInteraction, contentName, contentPiece, contentTarget) {
                if (isOverlaySession(configTrackerSiteId)) {
                    return;
                }
             ...
             */
            trackContentInteractionNode: function trackContentInteractionNode(domNode, contentInteraction) {
                if (isOverlaySession(configTrackerSiteId) || !domNode) {
                    return;
                }
             ...
             * content block.
             */
            logAllContentBlocksOnPage: function logAllContentBlocksOnPage() {
                var contentNodes = content.findContentNodes();
                var contents = content.collectContent(contentNodes);
             ...
             */
            trackSiteSearch: function trackSiteSearch(keyword, category, resultsCount) {
                trackCallback(function () {
             ...
             */
            setEcommerceView: function setEcommerceView(sku, name, category, price) {
             ...
             */
            addEcommerceItem: function addEcommerceItem(sku, name, category, price, quantity) {
                if (sku.length) {
             ...
             */
            trackEcommerceOrder: function trackEcommerceOrder(orderId, grandTotal, subTotal, tax, shipping, discount) {
             ...
             */
            trackEcommerceCartUpdate: function trackEcommerceCartUpdate(grandTotal) {
    ...
    Piwik = {
         ...
         * @return Tracker
         */
        getTracker: function getTracker(piwikUrl, siteId) {
            if (!isDefined(siteId)) {
