...
export var currentTime = new Date(1464778000).getTime() / 1000;
...
export var routeScheduleStopSelectOptions = [{ displayName: 'Kaisaniemenpuisto', value: 1 }, { displayName: 'Hakaniemi', value: 2 }, { displayName: 'Haapaniemi', value: 3 }, { displayName: 'Sörnäinen(M)', value: 4 }];

export var routeScheduleHeaderStops = [{ name: 'Kaisaniemenpuisto' }, { name: 'Hakaniemi' }, { name: 'Haapaniemi' }, { name: 'Sörnäinen(M)' }];

export var routePatterns = {
  pattern: {
    code: 'HSL:1007A:1:03',
    ...
    route: {
      ...
      patterns: [{ code: 'HSL:1007A:0:03', headsign: 'Pasila' }, { code: 'HSL:1007A:0:02', headsign: 'Pasila' }, { code: 'HSL:1007A:0:01', headsign: 'Pasila' }, { code: 'HSL:1007A:1:04', headsign: 'Sturenkatu' }, { code: 'HSL:1007A:1:03', headsign: 'Senaatintori' }, { code: 'HSL:1007A:1:02', headsign: 'Senaatintori' }, { code: 'HSL:1007A:1:01', headsign: 'Rautatieasema' }],
      shortName: '7A',
      mode: 'TRAM'
    }
  }
