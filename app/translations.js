...
const translations = {
  'da': {
    ...
    'not-implemented-msg': 'Hvis du vil deltage i udviklingen kan du finde mere information i følgende links',
    'now': 'Nu',
    ...
    'splash-geolocation-denied-message': 'Lokalisering er ikke tilladt. Kontroller indstillingene for din browser.',
    'splash-geolocation-not-supported-message': 'Din browser har ikke understøttelse for lokalisering.',
    'splash-geolocation-prompt-message': 'Venligst accepter lokalisering.',
    'splash-geolocation-watch-timeout-message': 'Lokalisering tager længre tid end forventet. Vælg udgangspunkt og prøv igen.',
    'splash-locating': 'Søger efter din position',
    'splash-or-choose': 'Eller fravælg din position',
    'splash-please-allow-positioning': 'Tjenesten fungerer bedst når du oplyser din position',
  ...
  'en': {
    ...
    'ticket-type-HSL:ker': 'Kerava and Sipoo',
    'ticket-type-HSL:kir': 'Kirkkonummi',
  ...
  'fi': {
    ...
    'ticket-type-HSL:hki': 'Helsinki',
    'ticket-type-HSL:ker': 'Kerava ja Sipoo',
    'ticket-type-HSL:kir': 'Kirkkonummi',
    'ticket-type-HSL:lse2': 'Lähiseutu2',
    'ticket-type-HSL:lse3': 'Lähiseutu3',
  ...
  'it': {
    ...
    'add-location-to-favourites': 'Aggiungi luogo ai preferiti',
    'address': 'Indirizzo',
    'address-or-stop': 'Indirizzo o fermata',
    'agency': 'Agenzia di trasporti',
    'airplane-with-route-number': 'Volo {routeNumber}',
    'airport-check-in': 'Check-in al desk {agency}',
    'airport-collect-luggage': 'Deposita i bagagli',
    'airport-security-check-go-to-gate': 'Procedo verso il gate passando per controllo di sicurezza',
    ...
    'back-to-front-page': 'Torna alla pagina principale',
    'bike-availability': 'Bici disponibili alla stazione ora',
    'bike-availability-short': 'Bici',
    'bus-with-route-number': 'Bus {routeNumber} {headSign}',
    'buy-ticket': 'Come comprare un biglietto (ataf.net)',
    'call': 'Chiama',
    'cancel': 'Annulla',
    'car-distance-duration': 'Auto {distance} ({duration})',
    'cause': 'causa',
    'char-left': 'caratteri',
    'choose-stop': 'Seleziona fermata',
    'citybike': 'City bike',
    'citybike-register-required': 'Per usare le bici devi registrarti',
    'close': 'Chiudi',
    'contact-information': 'Dettagli contatto di {contactName}',
    'create-account': 'Crea un account {contactName}',
    'cycle-distance-duration': 'Bici {distance} ({duration})',
    'cyclewalk-distance-duration': 'Bici a piedi {distance} ({duration})',
    'datasources': 'Fonti dati',
    'delete': 'Elimina',
    'departure-time-in-minutes': '{minutes} min',
    'departures': 'Partenze',
    'description': 'Cerca servizi di trasporto pubblico verso destinazioni vicine e lontane.',
    'destination': 'Destinazione',
    'destination-placeholder': 'Inserisci destinazione, itinerario o fermata',
    'digitransit-platform': 'Digitransit service platform',
    ...
    'earlier': 'Precedenti',
    'edit-favourites': 'Modifica il luogo nei Preferiti',
    'extra-info': 'Ulteriori informazioni',
    'favourite-target': 'Luoghi preferiti',
    'ferry-with-route-number': 'Traghetto {routeNumber} {headSign}',
    'footer-feedback': 'Invia feedback',
    'footer-link-to-old': 'Go to the old Journey Planner',
    'footer-link-to-privacy-policy': 'Informativa sulla privacy',
    'frontpage': 'Pagina principale',
    'geolocate-yourself': 'Rileva la tua posizione',
    'give-destination': 'Inserisci la tua destinazione',
    'give-name-to-location': 'Assegna una descrizione al luogo',
    'give-origin': 'Inserisci il luogo di partenza.',
    'give-position': 'Inserisci la tua posizione o il luogo di partenza nel campo di ricerca.',
    'hour-short': 'h',
    'how-to-rate-service': 'Come valuti questo servizio?',
    'in-addition': 'In aggiunta',
    'inquiry': 'How did you find the new Journey Planner? Please tell us!',
    'instructions': 'Istruzioni',
    'itinerary-feedback-button': 'Invia feedback',
    'itinerary-feedback-message': 'Non sei riuscito a trovare quello che cercavi?',
    'itinerary-feedback-placeholder': 'Descrizione (facoltativa)',
    'itinerary-hide-stops': 'Nascondi fermate',
    'itinerary-page.description': 'Itinerario',
    'itinerary-page.title': 'Itinerario',
    'itinerary-summary-page.description': 'Itinerari suggeriti',
    'itinerary-summary-page.title': 'Itinerari suggeriti',
    'later': 'Successivi',
    'leaves': 'Partenza',
    'leaving-at': 'Partenza alle',
    'likely-to-recommend': 'Consiglieresti il nostro servizio ai tuoi amici o colleghi?',
    'likely-to-use': 'How likely are you to use this service rather than the current Journey Planner?',
    'loading': 'Loading...',
    'locate': 'Rileva posizione',
    'location-examples': 'i.e. Casa, Lavoro, Scuole,...',
    'location-from-map': 'Luoghi selezionati',
    'login': 'Login',
    'long-transfers-margin': '12 min',
    'main-menu-label-open': 'Apri il menu principale',
    'main-mode': 'Sto viaggiando in ',
    'map': 'Mappa',
    'messagebar-label-close-message-bar': 'Chiudi banner',
    ...
    'next': 'Successivi',
    'no-favourite-locations': 'Aggiungi qui i tuoi luoghi più utlizzati. Il tuo viaggio verrà pianificato direttamente.',
    'no-favourites': 'Usa la stella per aggiungere i luoghi ai tuoi preferiti. I preferiti sono visualizzati in questa pagina.',
    'no-position': 'Nessuna posizione',
    'no-position-no-stops': 'La tua posizione non è disponibile. Non possiamo mostrare le fermate più vicine.',
    'no-route-msg': 'Sfortunatamente non sono stati trovati itinerari per questo viaggio. Per favore, modifica l\'indirizzo di partenza o di destinazione.',
    'no-route-start-end': 'Per favore seleziona una partenza e una destinazione.',
    'no-transfers-margin': '1 min',
    'no-trips-found': 'Non sono stati trovati viaggi per la data selezionata.',
    'not-implemented': 'La funzionalità {name} non è ancora disponibile',
    'not-implemented-msg': 'If you would like to participate in the development work, read more about the planned functions using the links below.',
    'now': 'Ora',
    'number-of-intermediate-stops': '{number, plural, =0 {No stops} one {1 stop} other {{number} stops} }',
    'off-canvas-info': 'Esegui l\'accesso per salvare i tuoi preferiti e utilizzarli in altri dispositivi.',
    'or': 'o',
    'origin': 'Origine',
    'origin-placeholder': 'Da? - indirizzo o fermata',
    'own-position': 'La tua posizione corrente',
    'page-not-found': 'La pagina non è stata trovata.',
    'park-and-ride': 'Park and Ride',
    'park-and-ride-availability': 'Posti disponibili',
    'pay-attention': 'N.B.',
    'pick-icon': 'Seleziona icona',
    'place-route-or-keyword': 'Destinatione, itinerario o fermata',
    'platform-num': 'Piattaforma {platformCode}',
    'platform-short': 'Plat. {platformCode}',
    'prefer-walking': 'Preferenza per lo spostamento a piedi',
    'previous': 'Precedente',
    'print': 'Stampa',
    'realtime-matching': 'Real-time integration',
    'rent-cycle-at': 'Noleggia una bici a {station}',
    'required-ticket': 'Biglietto richiesto per il viaggio',
    'right-now': 'Proprio ora',
    'route': 'Itinerario',
    'route-destination-arrives': 'Arrivi',
    'route-from-here': 'Parti da qui',
    'route-here': 'Arriva qui',
    'route-not-possible': 'Putroppo l\'itinerario non è disponibile a causa di un errore tecnico: "{error}"',
    'route-page.description': 'Percorso {route_short_name} - {route_long_name}',
    'route-page.title': 'Percorso {route_short_name}',
    'route-page.title-short': 'Percorso',
    'route-stop-or-keyword': 'Informazioni sul percorso o la fermata',
    'routes': 'Itinerari',
    'run': 'Corsa',
    'save': 'Salva',
    'search': 'Cerca',
    'search-destination-results-but-no-search': 'Visualizza i risultati nel tab “Destinazione”',
    'search-no-results': 'Nessuna posizione trovata',
    'search-position': 'Rileva posizione',
    'search-search-results-but-no-destination': 'Visualizza i risultati nel tab "Informazioni sul percorso o la fermata”',
    'searching-position': 'Rilevo la posizione...',
    'select-position': 'Seleziona la tua posizione dalle ricerche precedenti',
    'send': 'Invia',
    'settings': 'Impostazioni',
    'settings-reset': 'Ripristina impostazioni',
    'settings-savebutton': 'Salva impostazioni',
    'settings-saved': 'Modifiche salvate!',
    'share': 'Condividi itinerario',
    'show-departures': 'Mostra partenze',
    'show-more': 'Mostra di più',
    'show-routes': 'Mostra percorsi',
    'skip-positioning': 'Salta',
    'slow': 'Lento',
    'specify-location': 'Specifica posizione',
    'splash-geolocation-denied-message': 'You have not enabled location services. You can enable location services in your browser or phone settings.',
    'splash-geolocation-not-supported-message': 'Your browser does not support location retrieval.',
    'splash-geolocation-prompt-message': 'Accept your browser’s request to access your location.',
    'splash-geolocation-watch-timeout-message': 'Detecting your location is taking longer than expected. Have you accepted your browser’s request to access your location?',
    ...
    'terminal-page.title-short': 'Terminal',
    'terms-of-use': 'Terms of Use',
    'ticket-and-price-info': 'Informazioni sui biglietti e sul costo',
    ...
    'time': 'Ora',
    'timetable': 'Orari',
    'to-stop': 'Alla fermata',
    'today': 'Oggi',
    'tomorrow': 'Domani',
    'train-with-route-number': 'Treno {routeNumber} {headSign}',
    'tram-with-route-number': 'Tram {routeNumber} {headSign}',
    'transfers': 'Numbero di cambi',
    'transfers-allowed': 'Cambi mezzo consentiti',
    'transfers-margin': 'Margine minimo per il cambio mezzo',
    'trip-co2-emissions': 'Emissioni CO2 del viaggio',
    'trip-information': 'Informazioni sul viaggio',
    'trip-page.description': 'Percorso {route_short_name} - {route_long_name}',
    'trip-page.title': 'Percorso {route_short_name}',
    'try-again': 'Prova di nuovo',
    'use-citybike': 'Inizia ad usare',
    'use-own-position': 'Usa la posizione corrente',
    'using-modes': 'Voglio viaggiare in ',
    'very-likely': 'Molto probabile',
    'very-unlikely': 'Molto improbabile',
    'via-point': 'Punto intermedio',
    'view-route': 'Vedi percorso',
    'wait-amount-of-time': 'Attendi {duration}',
    'walk-distance-duration': 'Cammina per {distance} ({duration})',
    'walking': 'Dsitanza percorsa a piedi',
    'walking-speed': 'Velocità a piedi',
    'warning-call-agency': 'Solo su richiesta: {routeName}, che deve essere prenotato in anticipo.',
    'warning-call-agency-no-route': 'Solo su prenotazione.',
    'weather-at-destination': 'Condizioni meteo nella località di destinazione',
    'yesterday': 'Ieri',
    'your-favourites': 'Preferiti',
    'zones': 'Zone a pagamento',
  },
  ...
  'sv': {
    ...
    'ticket-type-HSL:ker': 'Kervo och Sibbo',
    'ticket-type-HSL:kir': 'Kyrkslätt',
